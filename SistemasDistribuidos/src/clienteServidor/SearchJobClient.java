...
public class SearchJobClient {
	...
	public void SearchJob(BufferedReader reader, PrintWriter out, BufferedReader in) throws IOException, JsonException, InterruptedException {
		...
		switch(opcao) {
		 case 1:
			 SearchJobSkills(reader, out, in);
			 return;
		case 2: 
			 SearchJobExperience(reader, out, in);
			 return;
		 case 3:
			 SearchJobTwo(reader, out, in);
			 return;
		default:
	...
	public void SearchJobSkills(BufferedReader reader, PrintWriter out, BufferedReader in) throws IOException, JsonException, InterruptedException{
		...
		JsonObject jsonRequest = CreateJson.createRequest("SEARCH_JOB");
	...
	public void SearchJobExperience(BufferedReader reader, PrintWriter out, BufferedReader in) throws IOException, JsonException, InterruptedException {
		CRUDClient auxToken = new CRUDClient();
		String token;
		token = auxToken.getToken();
	...
	public void SearchJobTwo(BufferedReader reader, PrintWriter out, BufferedReader in) throws IOException, JsonException, InterruptedException{
		CRUDClient auxToken = new CRUDClient();
		String token;
		token = auxToken.getToken();
